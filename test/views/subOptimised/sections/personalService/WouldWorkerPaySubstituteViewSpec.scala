  ...
  "WouldWorkerPaySubstitute view" must {
    ...
    "If the user type is of Worker" should {
      ...
      "have the correct title" in {
        document.title mustBe title(WouldPaySubstituteMessages.Worker.title, Some(SubHeadingMessages.SubOptimised.personalService))
      }
    ...
    "If the user type is of Hirer" should {
      ...
      "have the correct title" in {
        document.title mustBe title(WouldPaySubstituteMessages.Hirer.title, Some(SubHeadingMessages.SubOptimised.personalService))
      }
    ...
    "If the user type is of Agency" should {
      ...
      "have the correct title" in {
        document.title mustBe title(WouldPaySubstituteMessages.NonTailored.title, Some(SubHeadingMessages.SubOptimised.personalService))
      }
