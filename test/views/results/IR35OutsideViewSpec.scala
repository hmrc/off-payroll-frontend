...
class IR35OutsideViewSpec extends ResultViewFixture {
  ...
  def createView(req: DataRequest[_],
    ...
    view(postAction, isPrivateSector,isSubstituteToDoWork, isClientNotControlWork, isIncurCostNoReclaim)(req, messages, frontendAppConfig, testNoPdfResultDetails)
