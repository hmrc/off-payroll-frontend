...
import views.html.results.WorkerIR35UndeterminedView

class WorkerIR35UndeterminedViewSpec extends ViewSpecBase {
  ...
  val view = injector.instanceOf[WorkerIR35UndeterminedView]
