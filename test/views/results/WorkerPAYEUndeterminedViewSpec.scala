...
import views.html.results.WorkerPAYEUndeterminedView

class WorkerPAYEUndeterminedViewSpec extends ViewSpecBase {
  ...
  val view = injector.instanceOf[WorkerPAYEUndeterminedView]
