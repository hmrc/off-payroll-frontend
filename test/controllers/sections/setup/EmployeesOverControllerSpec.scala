...
class EmployeesOverControllerSpec extends ControllerSpecBase {

  val formProvider = new EmployeesOverFormProvider()
  ...
  "EmployeesOverController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(EmployeesOverPage.toString -> Json.toJson(Answers(true,0)))
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val answers = userAnswers.set(EmployeesOverPage,0,true)
