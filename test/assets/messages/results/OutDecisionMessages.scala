...
object OutDecisionMessages extends BaseResultMessages {
  ...
  object HirerIR35 {
    ...
    val doNextP1 = "If your organisation is responsible for paying the worker, you need to pay their earnings in full, without deducting tax and National Insurance. If someone else is responsible, you should download a copy of this result and show it to them."
  ...
  object Agent {
    ...
    val whyResultB3 = "the worker’s business will have costs for this work that their client will not pay for"
    val whyResultB4 = "the worker is providing services as a business"
    val whyResultP2 = "This suggests the worker is working on a business to business basis."
