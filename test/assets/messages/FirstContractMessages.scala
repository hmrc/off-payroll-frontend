...
object FirstContractMessages extends BaseMessages {
  ...
  object Worker {
    val error = "Select yes if the current contract is the first in a series of contracts with this client"
  ...
  object Hirer {
    val error = "Select yes if the current contract is the first in a series of contracts with your organisation"
