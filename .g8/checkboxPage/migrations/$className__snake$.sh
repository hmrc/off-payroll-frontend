...
echo "$className;format="decap"$.$checkbox1value;format="decap"$ = $checkbox1msg$" >> ../conf/messages.en
echo "$className;format="decap"$.$checkbox2value;format="decap"$ = $checkbox2msg$" >> ../conf/messages.en
echo "$className;format="decap"$.$checkbox3value;format="decap"$ = $checkbox3msg$" >> ../conf/messages.en
echo "$className;format="decap"$.$checkbox4value;format="decap"$ = $checkbox4msg$" >> ../conf/messages.en
...
echo "$className;format="decap"$.error.invalid = Select a valid option" >> ../conf/messages.en
